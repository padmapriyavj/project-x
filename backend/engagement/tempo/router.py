...
async def post_tempo_join(
    ...
    if str(q.get("type") or "") != "tempo":
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Not a tempo quiz")
...
async def post_dev_fire_tempo(quiz_id: UUID) -> TempoFireResponse:
